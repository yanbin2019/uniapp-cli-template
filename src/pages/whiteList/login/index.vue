<template>
	<view class="app-content">
		<image :src="logoPng" class="logo" alt="针布管家"></image>
		<view class="main">
			<view class="form">
				<u--form labelPosition="top" :model="modelForm" :rules="rules" ref="modelForm">
					<u-form-item prop="username">
						<u-input placeholder="请输入手机号" shape="circle" maxlength="11" clearable
					...
					<u-form-item v-else prop="code">
						<u-input placeholder="请输入验证码" shape="circle" maxlength="6" clearable v-model="modelForm.code">
						</u-input>
			...
			<view class="tab">
				...
				<u--text @tap="setLoginType" :text="codeShow ? '密码登录' : '验证码登录'"></u--text>
				<u--text @tap="toForget" text="忘记密码"></u--text>
			</view>
			<view class="btn">
				<u-button type="primary" @tap="login" size="large" shape="circle" text="登录"></u-button>
			</view>
		</view>
